...
var perms = [
	...
	'aclgroup', 'api_access', 'owner', 'developer', 'verified', 'official_ admin',
];
		...
		for(var row of table) {
			if(row.conditiontype == 'perm') {
				...
				switch(row.condition) {
					...
					} break; case 'official_admin': {
						if(hasperm(req, 'official_admin')) ret = 1;
					} break; case 'verified': {
						if(hasperm(req, 'verified')) ret = 1;
